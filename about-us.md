...
>
> Below are key excerpts from the RSS code of conduct. The complete Code of Conduct policy can be found <a href="/files/RSS{{ site.current_year }}-Rochester Security Summit Policy.pdf" target="_blank">here</a>
>
